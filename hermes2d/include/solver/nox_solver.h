...
namespace Hermes
{
  namespace Hermes2D
  {
    ...
    public:
      ...
      void set_precond(Teuchos::RCP<Preconditioners::Precond<Scalar> > &pc);
      /// \brief Accessor for preconditioner.
      Teuchos::RCP<Preconditioners::Precond<Scalar> > get_precond();
    ...
    private:
      ...
      Teuchos::RCP<Preconditioners::Precond<Scalar> > precond;
    };
    ...
    public:
      ...
      virtual void set_precond(Preconditioners::Precond<Scalar> &pc);
      /// Set preconditioner
