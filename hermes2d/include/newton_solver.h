...
namespace Hermes
{
  namespace Hermes2D
  {
    ...
    class HERMES_API NewtonSolver : public Hermes::Algebra::NonlinearSolver<Scalar>, public Hermes::Hermes2D::Mixins::SettableSpaces<Scalar>, public Hermes::Mixins::OutputAttachable, public Hermes::Hermes2D::Mixins::MatrixRhsOutput<Scalar>, public Hermes::Hermes2D::Mixins::StateQueryable
    {
    public:
      NewtonSolver();
