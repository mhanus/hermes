...
FIND_LIBRARY(CHOLMOD_LIBRARY      NAMES libcholmod cholmod          PATHS /usr/lib /usr/local/lib/CHOLMOD)
FIND_LIBRARY(COLAMD_LIBRARY      NAMES libcolamd colamd          PATHS /usr/lib /usr/local/lib/COLAMD)
...
SET(UMFPACK_LIBRARIES     ${UMFPACK_LIBRARY} ${SSC_LIBRARY} ${AMD_LIBRARY} ${CHOLMOD_LIBRARY} ${COLAMD_LIBRARY})
